    ...
    <div className="min-h-screen bg-stone-100 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative" dir="rtl">
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10 border border-stone-200">
          ...
          {!isAdminMode && <a href="/donations/seating" className="mt-5 flex w-full items-center justify-center gap-2 rounded-md border border-stone-300 px-4 py-2 text-sm font-medium text-stone-700 transition-colors hover:bg-stone-50"><Eye className="w-4 h-4" /> צפייה בשיבוץ</a>}
        </div>
      </div>
    </div>
  );
