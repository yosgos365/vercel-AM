        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10 border border-stone-200">
          ...
          {!isAdminMode && (
            <div className="mt-8 pt-6 border-t border-stone-100 text-sm text-stone-500">
              <p className="font-medium text-stone-700 mb-3">נתוני התחברות לדמו:</p>
              <ul className="space-y-2">
                <li className="flex justify-between items-center bg-stone-50 p-2 rounded border border-stone-100">
                  <span>מתפלל עם חובות:</span>
                  <span className="font-mono bg-white px-2 py-1 rounded text-blue-600 border border-stone-200">0521234567</span>
                </li>
              </ul>
            </div>
          )}
